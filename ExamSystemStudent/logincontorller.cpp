...
void CLoginContorller::initStudentDatabase()
{
    this->m_loginModel->initStudentDatabase();
}

void CLoginContorller::initStudentTable()
{
    this->m_loginModel->initStudentTable();
}
